...
(defn cfp-component []
  [:div#cfp
   ...
   [:p "Our CFP is currently closed. We'll soon open our CFP, make sure to follow us on "
    [:a {:href "https://twitter.com/clojuredays"} "@clojuredays"] " to get the news as soon as we open it up!"]])
