...
var mymap = L.map("location-map",cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$scrollWheelZoom,false], null))).setView(coords,(17));
dcd_website.map.init_tile_layer_BANG_(mymap);

return dcd_website.map.add_marker_BANG_(mymap,coords);
});
dcd_website.map.location_component = (function dcd_website$map$location_component(p__12795){
var map__12798 = p__12795;
var map__12798__$1 = ((((!((map__12798 == null)))?((((map__12798.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12798.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12798):map__12798);
var coords = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12798__$1,cljs.core.cst$kw$coords);
if(!((coords == null))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$not,cljs.core.list(cljs.core.cst$sym$nil_QMARK_,cljs.core.cst$sym$coords))], 0)))].join('')));
}

return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$reagent_DASH_render,((function (map__12798,map__12798__$1,coords){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$location,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,"Dutch Clojure Days will take place at the ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$href,"http://tq.co",cljs.core.cst$kw$target,cljs.core.cst$kw$_blank], null),"TQ"], null)," (Singel 542, 1017 AZ Amsterdam)."], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div_SHARP_location_DASH_map], null)], null);
});})(map__12798,map__12798__$1,coords))
,cljs.core.cst$kw$component_DASH_did_DASH_mount,((function (map__12798,map__12798__$1,coords){
return (function (){
