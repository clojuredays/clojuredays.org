...
dcd_website.map.location_component = (function dcd_website$map$location_component(p__12793){
var map__12796 = p__12793;
var map__12796__$1 = ((((!((map__12796 == null)))?((((map__12796.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12796.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12796):map__12796);
var coords = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12796__$1,cljs.core.cst$kw$coords);
if(!((coords == null))){
} else {
...
return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$reagent_DASH_render,((function (map__12796,map__12796__$1,coords){
return (function (){
...
});})(map__12796,map__12796__$1,coords))
,cljs.core.cst$kw$component_DASH_did_DASH_mount,((function (map__12796,map__12796__$1,coords){
return (function (){
