...
var G__12597 = o;
(G__12597[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12599__i < G__12599__a.length) {G__12599__a[G__12599__i] = arguments[G__12599__i + 0]; ++G__12599__i;}
  args = new cljs.core.IndexedSeq(G__12599__a,0);
} 
...
var G__12606 = jsprops;
(G__12606["defaultValue"] = value);

(G__12606["onChange"] = ((function (G__12606,v,value,on_change){
return (function (p1__12603_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12603_SHARP_);
});})(G__12606,v,value,on_change))
);

(G__12606["ref"] = ((function (G__12606,v,value,on_change){
return (function (p1__12604_SHARP_){
return (this$["cljsInputElement"] = p1__12604_SHARP_);
});})(G__12606,v,value,on_change))
);
...
var vec__12611 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12611,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12611,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12611,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12614 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12614 == null)){
} else {
var key_12615 = temp__4661__auto___12614;
(jsprops["key"] = key_12615);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12617 = (new reagent.impl.template.NativeWrapper());
(G__12617["name"] = c);
...
var G__12619 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12619) : reagent.impl.template.as_element.call(null,G__12619));
} else {
...
var len__7515__auto___12625 = arguments.length;
var i__7516__auto___12626 = (0);
while(true){
if((i__7516__auto___12626 < len__7515__auto___12625)){
args__7522__auto__.push((arguments[i__7516__auto___12626]));

var G__12627 = (i__7516__auto___12626 + (1));
i__7516__auto___12626 = G__12627;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12623){
var G__12624 = cljs.core.first(seq12623);
var seq12623__$1 = cljs.core.next(seq12623);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12624,seq12623__$1);
});
...
break;
default:
var G__12631 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12631;
continue;
...
var n__7360__auto___12634 = a.length;
var i_12635 = (0);
while(true){
if((i_12635 < n__7360__auto___12634)){
(a[i_12635] = reagent.impl.template.as_element((a[i_12635])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7360__auto___12637 = a.length;
var i_12638 = (0);
while(true){
if((i_12638 < n__7360__auto___12637)){
var val_12639 = (a[i_12638]);
if((cljs.core.vector_QMARK_(val_12639)) && ((reagent.impl.template.key_from_vec(val_12639) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12638] = reagent.impl.template.as_element(val_12639));

var G__12640 = (i_12638 + (1));
i_12638 = G__12640;
continue;
} else {
}
...
var ctx = {};
var vec__12642 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12642,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12642,(1),null);
...
var G__12644 = (cljs.core.count(argv) - first_child);
switch (G__12644) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12644){
