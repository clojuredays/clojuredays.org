...
var G__12580 = o;
(G__12580[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12589 = jsprops;
(G__12589["defaultValue"] = value);

(G__12589["onChange"] = ((function (G__12589,v,value,on_change){
return (function (p1__12586_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12586_SHARP_);
});})(G__12589,v,value,on_change))
);

(G__12589["ref"] = ((function (G__12589,v,value,on_change){
return (function (p1__12587_SHARP_){
return (this$["cljsInputElement"] = p1__12587_SHARP_);
});})(G__12589,v,value,on_change))
);
...
var vec__12594 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12597 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12597 == null)){
} else {
var key_12598 = temp__4661__auto___12597;
(jsprops["key"] = key_12598);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12600 = (new reagent.impl.template.NativeWrapper());
(G__12600["name"] = c);
...
var G__12602 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12602) : reagent.impl.template.as_element.call(null,G__12602));
} else {
...
var len__7515__auto___12608 = arguments.length;
var i__7516__auto___12609 = (0);
while(true){
if((i__7516__auto___12609 < len__7515__auto___12608)){
args__7522__auto__.push((arguments[i__7516__auto___12609]));

var G__12610 = (i__7516__auto___12609 + (1));
i__7516__auto___12609 = G__12610;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12606){
var G__12607 = cljs.core.first(seq12606);
var seq12606__$1 = cljs.core.next(seq12606);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12607,seq12606__$1);
});
...
break;
default:
var G__12614 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12614;
continue;
...
var n__7360__auto___12617 = a.length;
var i_12618 = (0);
while(true){
if((i_12618 < n__7360__auto___12617)){
(a[i_12618] = reagent.impl.template.as_element((a[i_12618])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7360__auto___12620 = a.length;
var i_12621 = (0);
while(true){
if((i_12621 < n__7360__auto___12620)){
var val_12622 = (a[i_12621]);
if((cljs.core.vector_QMARK_(val_12622)) && ((reagent.impl.template.key_from_vec(val_12622) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12621] = reagent.impl.template.as_element(val_12622));

var G__12623 = (i_12621 + (1));
i_12621 = G__12623;
continue;
} else {
}
...
var ctx = {};
var vec__12625 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(1),null);
...
var G__12627 = (cljs.core.count(argv) - first_child);
switch (G__12627) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12627){
