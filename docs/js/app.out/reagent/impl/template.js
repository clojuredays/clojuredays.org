...
var G__12594 = o;
(G__12594[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12603 = jsprops;
(G__12603["defaultValue"] = value);

(G__12603["onChange"] = ((function (G__12603,v,value,on_change){
return (function (p1__12600_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12600_SHARP_);
});})(G__12603,v,value,on_change))
);

(G__12603["ref"] = ((function (G__12603,v,value,on_change){
return (function (p1__12601_SHARP_){
return (this$["cljsInputElement"] = p1__12601_SHARP_);
});})(G__12603,v,value,on_change))
);
...
var vec__12608 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12611 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12611 == null)){
} else {
var key_12612 = temp__4661__auto___12611;
(jsprops["key"] = key_12612);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12614 = (new reagent.impl.template.NativeWrapper());
(G__12614["name"] = c);
...
var G__12616 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12616) : reagent.impl.template.as_element.call(null,G__12616));
} else {
...
var len__7524__auto___12622 = arguments.length;
var i__7525__auto___12623 = (0);
while(true){
if((i__7525__auto___12623 < len__7524__auto___12622)){
args__7531__auto__.push((arguments[i__7525__auto___12623]));

var G__12624 = (i__7525__auto___12623 + (1));
i__7525__auto___12623 = G__12624;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12620){
var G__12621 = cljs.core.first(seq12620);
var seq12620__$1 = cljs.core.next(seq12620);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12621,seq12620__$1);
});
...
break;
default:
var G__12628 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12628;
continue;
...
var n__7369__auto___12631 = a.length;
var i_12632 = (0);
while(true){
if((i_12632 < n__7369__auto___12631)){
(a[i_12632] = reagent.impl.template.as_element((a[i_12632])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7369__auto___12634 = a.length;
var i_12635 = (0);
while(true){
if((i_12635 < n__7369__auto___12634)){
var val_12636 = (a[i_12635]);
if((cljs.core.vector_QMARK_(val_12636)) && ((reagent.impl.template.key_from_vec(val_12636) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12635] = reagent.impl.template.as_element(val_12636));
...
var ctx = {};
var vec__12639 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12639,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12639,(1),null);
...
var G__12641 = (cljs.core.count(argv) - first_child);
switch (G__12641) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12641){
