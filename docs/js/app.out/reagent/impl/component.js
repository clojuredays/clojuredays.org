...
if((i < len)){
var k = (ks[i]);
var G__12519 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12520 = (i + (1));
m = G__12519;
i = G__12520;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12524 = c;
var G__12524__$1 = (((G__12524 == null))?null:G__12524.prototype);
if((G__12524__$1 == null)){
return null;
} else {
return (G__12524__$1["reagentRender"]);
}
})()));
});
...
var G__12532 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12532) : reagent.impl.component.as_element.call(null,G__12532));
};
...
var _STAR_current_component_STAR_12539 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12539;
}});
...
var G__12547 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12547) {
...
return ((function (G__12547){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12550 = reagent.impl.component.state_atom(c);
var G__12551 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12550,G__12551) : cljs.core.reset_BANG_.call(null,G__12550,G__12551));
});
;})(G__12547))
...
var c = this;
var G__12553_12555 = (c["cljsRatom"]);
if((G__12553_12555 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12553_12555);
}
...
var renders_12558 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12559 = cljs.core.first(cljs.core.vals(renders_12558));
if((cljs.core.count(renders_12558) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12558))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12559)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12559], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$ifn_QMARK_,cljs.core.cst$sym$render_DASH_fun)], 0)))].join('')));
}
...
var name__$1 = (function (){var G__12557 = name;
switch (G__12557) {
case "":
...
var elem = (function (){var G__12568 = (function (){var or__6457__auto__ = (function (){var G__12570 = c;
if((G__12570 == null)){
return null;
} else {
return (G__12570["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6457__auto__)){
return or__6457__auto__;
...
return (G__12568["_currentElement"]);
}
})();
var name = (function (){var G__12571 = elem;
var G__12571__$1 = (((G__12571 == null))?null:(G__12571["type"]));
if((G__12571__$1 == null)){
return null;
} else {
return (G__12571__$1["displayName"]);
}
})();
var path = (function (){var G__12572 = elem;
var G__12572__$1 = (((G__12572 == null))?null:(G__12572["_owner"]));
var G__12572__$2 = (((G__12572__$1 == null))?null:reagent$impl$component$component_path(G__12572__$1));
if((G__12572__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12572__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__12574 = c;
var G__12574__$1 = (((G__12574 == null))?null:G__12574.constructor);
if((G__12574__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12574__$1);
}
}
})();
