...
if((i < len)){
var k = (ks[i]);
var G__12503 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12504 = (i + (1));
m = G__12503;
i = G__12504;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12508 = c;
var G__12508__$1 = (((G__12508 == null))?null:G__12508.prototype);
if((G__12508__$1 == null)){
return null;
} else {
return (G__12508__$1["reagentRender"]);
}
})()));
});
...
var G__12516 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12516) : reagent.impl.component.as_element.call(null,G__12516));
};
...
var _STAR_current_component_STAR_12523 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12523;
}});
...
var G__12531 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12531) {
...
return ((function (G__12531){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12534 = reagent.impl.component.state_atom(c);
var G__12535 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12534,G__12535) : cljs.core.reset_BANG_.call(null,G__12534,G__12535));
});
;})(G__12531))
...
var c = this;
var G__12537_12539 = (c["cljsRatom"]);
if((G__12537_12539 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12537_12539);
}
...
var renders_12542 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12543 = cljs.core.first(cljs.core.vals(renders_12542));
if((cljs.core.count(renders_12542) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12542))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12543)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12543], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$ifn_QMARK_,cljs.core.cst$sym$render_DASH_fun)], 0)))].join('')));
}
...
var name__$1 = (function (){var G__12541 = name;
switch (G__12541) {
case "":
...
var elem = (function (){var G__12552 = (function (){var or__6457__auto__ = (function (){var G__12554 = c;
if((G__12554 == null)){
return null;
} else {
return (G__12554["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6457__auto__)){
return or__6457__auto__;
...
return (G__12552["_currentElement"]);
}
})();
var name = (function (){var G__12555 = elem;
var G__12555__$1 = (((G__12555 == null))?null:(G__12555["type"]));
if((G__12555__$1 == null)){
return null;
} else {
return (G__12555__$1["displayName"]);
}
})();
var path = (function (){var G__12556 = elem;
var G__12556__$1 = (((G__12556 == null))?null:(G__12556["_owner"]));
var G__12556__$2 = (((G__12556__$1 == null))?null:reagent$impl$component$component_path(G__12556__$1));
if((G__12556__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12556__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__12558 = c;
var G__12558__$1 = (((G__12558 == null))?null:G__12558.constructor);
if((G__12558__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12558__$1);
}
}
})();
