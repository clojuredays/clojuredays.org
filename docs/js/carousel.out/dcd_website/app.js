...
goog.require('dcd_website.dcd2020');
goog.require('dcd_website.sidebar');
goog.require('dcd_website.map');
goog.require('dcd_website.state');
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(dcd_website.state.website_structure,dcd_website.dcd2020.dcd2020_website_structure) : cljs.core.reset_BANG_.call(null,dcd_website.state.website_structure,dcd_website.dcd2020.dcd2020_website_structure));
dcd_website.app.website_component = (function dcd_website$app$website_component(){
var map__12836 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(dcd_website.state.website_structure) : cljs.core.deref.call(null,dcd_website.state.website_structure));
...
var header_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12836__$1,cljs.core.cst$kw$header_DASH_component);
var main_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12836__$1,cljs.core.cst$kw$main_DASH_component);
var footer_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12836__$1,cljs.core.cst$kw$footer_DASH_component);
...
var G__12840 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [dcd_website.app.website_component], null);
var G__12841 = root;
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__12840,G__12841) : reagent.core.render_component.call(null,G__12840,G__12841));
} else {
return null;
}
} else {
