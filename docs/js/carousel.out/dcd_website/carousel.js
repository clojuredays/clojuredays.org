...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12838__$1,cljs.core.cst$kw$type);
var force_timeline_visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12838__$1,cljs.core.cst$kw$force_DASH_timeline_DASH_visible_QMARK_);
var force_timeline_hidden_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12838__$1,cljs.core.cst$kw$force_DASH_timeline_DASH_hidden_QMARK_);
...
dcd_website.carousel.agenda_start = (function (){var start = (function (){var G__12840 = (new Date());
G__12840.setHours((8));

G__12840.setMinutes((30));
...
var vec__12842 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.int$,clojure.string.split.cljs$core$IFn$_invoke$arity$2(s,/:/));
var hh = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12842,(0),null);
var mm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12842,(1),null);
...
dcd_website.carousel.render_slot = (function (){var method_table__7370__auto__ = (function (){var G__12843 = cljs.core.PersistentArrayMap.EMPTY;
...
var prefer_table__7371__auto__ = (function (){var G__12844 = cljs.core.PersistentArrayMap.EMPTY;
...
var method_cache__7372__auto__ = (function (){var G__12845 = cljs.core.PersistentArrayMap.EMPTY;
...
var cached_hierarchy__7373__auto__ = (function (){var G__12846 = cljs.core.PersistentArrayMap.EMPTY;
...
return (function (p__12847,_,___$1){
var map__12848 = p__12847;
var map__12848__$1 = ((((!((map__12848 == null)))?((((map__12848.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12848.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12848):map__12848);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12848__$1,cljs.core.cst$kw$type);
return type;
...
dcd_website.carousel.render_slot.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$org,(function (p__12850,bg,fg){
...
var slot = map__12851__$1;
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12851__$1,cljs.core.cst$kw$title);
var vec__12852 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12851__$1,cljs.core.cst$kw$time);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12852,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12852,(1),null);
var author = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12851__$1,cljs.core.cst$kw$author);
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12851__$1,cljs.core.cst$kw$timeline_DASH_description);
var add_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12851__$1,cljs.core.cst$kw$add_DASH_paggind);
...
dcd_website.carousel.render_talk_slot = (function dcd_website$carousel$render_talk_slot(p__12854,bg,fg){
...
var pic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12858__$1,cljs.core.cst$kw$profile_DASH_pic);
var author = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12858__$1,cljs.core.cst$kw$author);
var add_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12858__$1,cljs.core.cst$kw$add_DASH_padding);
...
var G__12866_12869 = dcd_website.carousel.progress;
var G__12867_12870 = dcd_website.carousel.current_progress((function (){var G__12868 = (new Date());
G__12868.setHours((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(dcd_website.carousel.test_progress) : cljs.core.deref.call(null,dcd_website.carousel.test_progress)));

G__12868.setMinutes((20));

return G__12868;
})());
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12866_12869,G__12867_12870) : cljs.core.reset_BANG_.call(null,G__12866_12869,G__12867_12870));
...
var d = (new Date());
if((d.getHours() < (19))){
var G__12877_12883 = dcd_website.carousel.progress;
var G__12878_12884 = dcd_website.carousel.current_progress(d);
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12877_12883,G__12878_12884) : cljs.core.reset_BANG_.call(null,G__12877_12883,G__12878_12884));

return true;
} else {
var G__12880_12885 = dcd_website.carousel.progress;
var G__12881_12886 = dcd_website.carousel.current_progress((function (){var G__12882 = d;
G__12882.setHours((19));

G__12882.setMinutes((20));

return G__12882;
})());
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12880_12885,G__12881_12886) : cljs.core.reset_BANG_.call(null,G__12880_12885,G__12881_12886));

return false;
}
});
dcd_website.carousel.set_time_test = (function dcd_website$carousel$set_time_test(hh,mm){
var G__12892 = dcd_website.carousel.progress;
var G__12893 = dcd_website.carousel.current_progress((function (){var G__12894 = (new Date());
G__12894.setHours(hh);

G__12894.setMinutes(mm);
...
var G__12897_12899 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [dcd_website.carousel.carousel_component], null);
var G__12898_12900 = root;
(reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__12897_12899,G__12898_12900) : reagent.core.render_component.call(null,G__12897_12899,G__12898_12900));
