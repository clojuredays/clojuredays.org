...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7064__auto__,writer__7065__auto__,opt__7066__auto__){
return cljs.core._write(writer__7065__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12579 = o;
(G__12579[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12580__delegate = function (args){
...
while (G__12581__i < G__12581__a.length) {G__12581__a[G__12581__i] = arguments[G__12581__i + 0]; ++G__12581__i;}
  args = new cljs.core.IndexedSeq(G__12581__a,0);
} 
return G__12580__delegate.call(this,args);};
...
return G__12580__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6454__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__6454__auto__){
var and__6454__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__6454__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__6454__auto____$1;
}
} else {
...
var G__12588 = jsprops;
(G__12588["defaultValue"] = value);

(G__12588["onChange"] = ((function (G__12588,v,value,on_change){
return (function (p1__12585_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12585_SHARP_);
});})(G__12588,v,value,on_change))
);

(G__12588["ref"] = ((function (G__12588,v,value,on_change){
return (function (p1__12586_SHARP_){
return (this$["cljsInputElement"] = p1__12586_SHARP_);
});})(G__12588,v,value,on_change))
);
...
var vec__12593 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12593,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12593,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12593,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12596 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12596 == null)){
} else {
var key_12597 = temp__4661__auto___12596;
(jsprops["key"] = key_12597);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12599 = (new reagent.impl.template.NativeWrapper());
(G__12599["name"] = c);
...
var G__12601 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12601) : reagent.impl.template.as_element.call(null,G__12601));
} else {
...
var len__7524__auto___12607 = arguments.length;
var i__7525__auto___12608 = (0);
while(true){
if((i__7525__auto___12608 < len__7524__auto___12607)){
args__7531__auto__.push((arguments[i__7525__auto___12608]));

var G__12609 = (i__7525__auto___12608 + (1));
i__7525__auto___12608 = G__12609;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7532__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12605){
var G__12606 = cljs.core.first(seq12605);
var seq12605__$1 = cljs.core.next(seq12605);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12606,seq12605__$1);
});
...
break;
default:
var G__12613 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12613;
continue;
...
var n__7369__auto___12616 = a.length;
var i_12617 = (0);
while(true){
if((i_12617 < n__7369__auto___12616)){
(a[i_12617] = reagent.impl.template.as_element((a[i_12617])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7369__auto___12619 = a.length;
var i_12620 = (0);
while(true){
if((i_12620 < n__7369__auto___12619)){
var val_12621 = (a[i_12620]);
if((cljs.core.vector_QMARK_(val_12621)) && ((reagent.impl.template.key_from_vec(val_12621) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12620] = reagent.impl.template.as_element(val_12621));

var G__12622 = (i_12620 + (1));
i_12620 = G__12622;
continue;
} else {
}
...
var ctx = {};
var vec__12624 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12624,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12624,(1),null);
...
var G__12626 = (cljs.core.count(argv) - first_child);
switch (G__12626) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12626){
