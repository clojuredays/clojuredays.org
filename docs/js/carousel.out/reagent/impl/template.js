...
var G__12568 = o;
(G__12568[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6443__auto__ = cljs.core.some_QMARK_(jsprops);
...
var G__12577 = jsprops;
(G__12577["defaultValue"] = value);

(G__12577["onChange"] = ((function (G__12577,v,value,on_change){
return (function (p1__12574_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12574_SHARP_);
});})(G__12577,v,value,on_change))
);

(G__12577["ref"] = ((function (G__12577,v,value,on_change){
return (function (p1__12575_SHARP_){
return (this$["cljsInputElement"] = p1__12575_SHARP_);
});})(G__12577,v,value,on_change))
);
...
var vec__12582 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12585 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12585 == null)){
} else {
var key_12586 = temp__4661__auto___12585;
(jsprops["key"] = key_12586);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12588 = (new reagent.impl.template.NativeWrapper());
(G__12588["name"] = c);
...
var G__12590 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12590) : reagent.impl.template.as_element.call(null,G__12590));
} else {
...
var len__7513__auto___12596 = arguments.length;
var i__7514__auto___12597 = (0);
while(true){
if((i__7514__auto___12597 < len__7513__auto___12596)){
args__7520__auto__.push((arguments[i__7514__auto___12597]));

var G__12598 = (i__7514__auto___12597 + (1));
i__7514__auto___12597 = G__12598;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12594){
var G__12595 = cljs.core.first(seq12594);
var seq12594__$1 = cljs.core.next(seq12594);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12595,seq12594__$1);
});
...
break;
default:
var G__12602 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12602;
continue;
...
var n__7358__auto___12605 = a.length;
var i_12606 = (0);
while(true){
if((i_12606 < n__7358__auto___12605)){
(a[i_12606] = reagent.impl.template.as_element((a[i_12606])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7358__auto___12608 = a.length;
var i_12609 = (0);
while(true){
if((i_12609 < n__7358__auto___12608)){
var val_12610 = (a[i_12609]);
if((cljs.core.vector_QMARK_(val_12610)) && ((reagent.impl.template.key_from_vec(val_12610) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12609] = reagent.impl.template.as_element(val_12610));

var G__12611 = (i_12609 + (1));
i_12609 = G__12611;
continue;
} else {
}
...
var ctx = {};
var vec__12613 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12613,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12613,(1),null);
...
var G__12615 = (cljs.core.count(argv) - first_child);
switch (G__12615) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12615){
