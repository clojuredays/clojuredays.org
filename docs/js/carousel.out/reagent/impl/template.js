...
var G__12584 = o;
(G__12584[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12585__delegate = function (args){
...
while (G__12586__i < G__12586__a.length) {G__12586__a[G__12586__i] = arguments[G__12586__i + 0]; ++G__12586__i;}
  args = new cljs.core.IndexedSeq(G__12586__a,0);
} 
...
var G__12593 = jsprops;
(G__12593["defaultValue"] = value);

(G__12593["onChange"] = ((function (G__12593,v,value,on_change){
return (function (p1__12590_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12590_SHARP_);
});})(G__12593,v,value,on_change))
);

(G__12593["ref"] = ((function (G__12593,v,value,on_change){
return (function (p1__12591_SHARP_){
return (this$["cljsInputElement"] = p1__12591_SHARP_);
});})(G__12593,v,value,on_change))
);
...
var vec__12598 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12598,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12598,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12598,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12601 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12601 == null)){
} else {
var key_12602 = temp__4661__auto___12601;
(jsprops["key"] = key_12602);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12604 = (new reagent.impl.template.NativeWrapper());
(G__12604["name"] = c);
...
var G__12606 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12606) : reagent.impl.template.as_element.call(null,G__12606));
} else {
...
var len__7515__auto___12612 = arguments.length;
var i__7516__auto___12613 = (0);
while(true){
if((i__7516__auto___12613 < len__7515__auto___12612)){
args__7522__auto__.push((arguments[i__7516__auto___12613]));

var G__12614 = (i__7516__auto___12613 + (1));
i__7516__auto___12613 = G__12614;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12610){
var G__12611 = cljs.core.first(seq12610);
var seq12610__$1 = cljs.core.next(seq12610);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12611,seq12610__$1);
});
...
break;
default:
var G__12618 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12618;
continue;
...
var n__7360__auto___12621 = a.length;
var i_12622 = (0);
while(true){
if((i_12622 < n__7360__auto___12621)){
(a[i_12622] = reagent.impl.template.as_element((a[i_12622])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7360__auto___12624 = a.length;
var i_12625 = (0);
while(true){
if((i_12625 < n__7360__auto___12624)){
var val_12626 = (a[i_12625]);
if((cljs.core.vector_QMARK_(val_12626)) && ((reagent.impl.template.key_from_vec(val_12626) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12625] = reagent.impl.template.as_element(val_12626));

var G__12627 = (i_12625 + (1));
i_12625 = G__12627;
continue;
} else {
}
...
var ctx = {};
var vec__12629 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12629,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12629,(1),null);
...
var G__12631 = (cljs.core.count(argv) - first_child);
switch (G__12631) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12631){
