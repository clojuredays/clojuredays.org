...
var G__12600 = o;
(G__12600[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12601__delegate = function (args){
...
while (G__12602__i < G__12602__a.length) {G__12602__a[G__12602__i] = arguments[G__12602__i + 0]; ++G__12602__i;}
  args = new cljs.core.IndexedSeq(G__12602__a,0);
} 
...
var G__12609 = jsprops;
(G__12609["defaultValue"] = value);

(G__12609["onChange"] = ((function (G__12609,v,value,on_change){
return (function (p1__12606_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12606_SHARP_);
});})(G__12609,v,value,on_change))
);

(G__12609["ref"] = ((function (G__12609,v,value,on_change){
return (function (p1__12607_SHARP_){
return (this$["cljsInputElement"] = p1__12607_SHARP_);
});})(G__12609,v,value,on_change))
);
...
var vec__12614 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12614,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12614,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12614,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12617 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12617 == null)){
} else {
var key_12618 = temp__4661__auto___12617;
(jsprops["key"] = key_12618);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12620 = (new reagent.impl.template.NativeWrapper());
(G__12620["name"] = c);
...
var G__12622 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12622) : reagent.impl.template.as_element.call(null,G__12622));
} else {
...
var len__7515__auto___12628 = arguments.length;
var i__7516__auto___12629 = (0);
while(true){
if((i__7516__auto___12629 < len__7515__auto___12628)){
args__7522__auto__.push((arguments[i__7516__auto___12629]));

var G__12630 = (i__7516__auto___12629 + (1));
i__7516__auto___12629 = G__12630;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12626){
var G__12627 = cljs.core.first(seq12626);
var seq12626__$1 = cljs.core.next(seq12626);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12627,seq12626__$1);
});
...
break;
default:
var G__12634 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12634;
continue;
...
(a[i_12638] = reagent.impl.template.as_element((a[i_12638])));

var G__12639 = (i_12638 + (1));
i_12638 = G__12639;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7360__auto___12640 = a.length;
var i_12641 = (0);
while(true){
if((i_12641 < n__7360__auto___12640)){
var val_12642 = (a[i_12641]);
if((cljs.core.vector_QMARK_(val_12642)) && ((reagent.impl.template.key_from_vec(val_12642) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12641] = reagent.impl.template.as_element(val_12642));
...
var ctx = {};
var vec__12645 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12645,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12645,(1),null);
...
var G__12647 = (cljs.core.count(argv) - first_child);
switch (G__12647) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12647){
