...
var G__12572 = o;
(G__12572[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12581 = jsprops;
(G__12581["defaultValue"] = value);

(G__12581["onChange"] = ((function (G__12581,v,value,on_change){
return (function (p1__12578_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12578_SHARP_);
});})(G__12581,v,value,on_change))
);

(G__12581["ref"] = ((function (G__12581,v,value,on_change){
return (function (p1__12579_SHARP_){
return (this$["cljsInputElement"] = p1__12579_SHARP_);
});})(G__12581,v,value,on_change))
);
...
var vec__12586 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12589 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12589 == null)){
} else {
var key_12590 = temp__4661__auto___12589;
(jsprops["key"] = key_12590);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12592 = (new reagent.impl.template.NativeWrapper());
(G__12592["name"] = c);
...
var G__12594 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12594) : reagent.impl.template.as_element.call(null,G__12594));
} else {
...
var len__7515__auto___12600 = arguments.length;
var i__7516__auto___12601 = (0);
while(true){
if((i__7516__auto___12601 < len__7515__auto___12600)){
args__7522__auto__.push((arguments[i__7516__auto___12601]));

var G__12602 = (i__7516__auto___12601 + (1));
i__7516__auto___12601 = G__12602;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12598){
var G__12599 = cljs.core.first(seq12598);
var seq12598__$1 = cljs.core.next(seq12598);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12599,seq12598__$1);
});
...
break;
default:
var G__12606 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12606;
continue;
...
var n__7360__auto___12609 = a.length;
var i_12610 = (0);
while(true){
if((i_12610 < n__7360__auto___12609)){
(a[i_12610] = reagent.impl.template.as_element((a[i_12610])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7360__auto___12612 = a.length;
var i_12613 = (0);
while(true){
if((i_12613 < n__7360__auto___12612)){
var val_12614 = (a[i_12613]);
if((cljs.core.vector_QMARK_(val_12614)) && ((reagent.impl.template.key_from_vec(val_12614) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12613] = reagent.impl.template.as_element(val_12614));

var G__12615 = (i_12613 + (1));
i_12613 = G__12615;
continue;
} else {
}
...
var ctx = {};
var vec__12617 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12617,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12617,(1),null);
...
var G__12619 = (cljs.core.count(argv) - first_child);
switch (G__12619) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12619){
