...
if((i < len)){
var k = (ks[i]);
var G__12507 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12508 = (i + (1));
m = G__12507;
i = G__12508;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12512 = c;
var G__12512__$1 = (((G__12512 == null))?null:G__12512.prototype);
if((G__12512__$1 == null)){
return null;
} else {
return (G__12512__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12516 = c;
var G__12516__$1 = (((G__12516 == null))?null:G__12516.prototype);
if((G__12516__$1 == null)){
return null;
} else {
return (G__12516__$1["render"]);
}
})()));
});
...
return (function() { 
var G__12522__delegate = function (args){
var G__12520 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12520) : reagent.impl.component.as_element.call(null,G__12520));
};
...
while (G__12523__i < G__12523__a.length) {G__12523__a[G__12523__i] = arguments[G__12523__i + 0]; ++G__12523__i;}
  args = new cljs.core.IndexedSeq(G__12523__a,0);
} 
...
var _STAR_current_component_STAR_12527 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12527;
}});
...
var G__12535 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12535) {
...
return ((function (G__12535){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12538 = reagent.impl.component.state_atom(c);
var G__12539 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12538,G__12539) : cljs.core.reset_BANG_.call(null,G__12538,G__12539));
});
;})(G__12535))
...
var c = this;
var G__12541_12543 = (c["cljsRatom"]);
if((G__12541_12543 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12541_12543);
}
...
var renders_12546 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12547 = cljs.core.first(cljs.core.vals(renders_12546));
if((cljs.core.count(renders_12546) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12546))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12547)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12547], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$ifn_QMARK_,cljs.core.cst$sym$render_DASH_fun)], 0)))].join('')));
}
...
var name__$1 = (function (){var G__12545 = name;
switch (G__12545) {
case "":
...
var elem = (function (){var G__12556 = (function (){var or__6457__auto__ = (function (){var G__12558 = c;
if((G__12558 == null)){
return null;
} else {
return (G__12558["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6457__auto__)){
return or__6457__auto__;
...
return (G__12556["_currentElement"]);
}
})();
var name = (function (){var G__12559 = elem;
var G__12559__$1 = (((G__12559 == null))?null:(G__12559["type"]));
if((G__12559__$1 == null)){
return null;
} else {
return (G__12559__$1["displayName"]);
}
})();
var path = (function (){var G__12560 = elem;
var G__12560__$1 = (((G__12560 == null))?null:(G__12560["_owner"]));
var G__12560__$2 = (((G__12560__$1 == null))?null:reagent$impl$component$component_path(G__12560__$1));
if((G__12560__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12560__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__12562 = c;
var G__12562__$1 = (((G__12562 == null))?null:G__12562.constructor);
if((G__12562__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12562__$1);
}
}
})();
