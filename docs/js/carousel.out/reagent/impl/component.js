...
if((i < len)){
var k = (ks[i]);
var G__12495 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12496 = (i + (1));
m = G__12495;
i = G__12496;
continue;
...
if((G__12500__$1 == null)){
return null;
} else {
return (G__12500__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12504 = c;
var G__12504__$1 = (((G__12504 == null))?null:G__12504.prototype);
if((G__12504__$1 == null)){
return null;
} else {
return (G__12504__$1["render"]);
}
})()));
});
...
var G__12508 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12508) : reagent.impl.component.as_element.call(null,G__12508));
};
...
var _STAR_current_component_STAR_12515 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12515;
}});
...
var G__12523 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12523) {
...
return ((function (G__12523){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12526 = reagent.impl.component.state_atom(c);
var G__12527 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12526,G__12527) : cljs.core.reset_BANG_.call(null,G__12526,G__12527));
});
;})(G__12523))
...
var c = this;
var G__12529_12531 = (c["cljsRatom"]);
if((G__12529_12531 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12529_12531);
}
...
var renders_12534 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12535 = cljs.core.first(cljs.core.vals(renders_12534));
if((cljs.core.count(renders_12534) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12534))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12535)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12535], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$ifn_QMARK_,cljs.core.cst$sym$render_DASH_fun)], 0)))].join('')));
}
...
var name__$1 = (function (){var G__12533 = name;
switch (G__12533) {
case "":
...
var elem = (function (){var G__12544 = (function (){var or__6457__auto__ = (function (){var G__12546 = c;
if((G__12546 == null)){
return null;
} else {
return (G__12546["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6457__auto__)){
return or__6457__auto__;
...
return (G__12544["_currentElement"]);
}
})();
var name = (function (){var G__12547 = elem;
var G__12547__$1 = (((G__12547 == null))?null:(G__12547["type"]));
if((G__12547__$1 == null)){
return null;
} else {
return (G__12547__$1["displayName"]);
}
})();
var path = (function (){var G__12548 = elem;
var G__12548__$1 = (((G__12548 == null))?null:(G__12548["_owner"]));
var G__12548__$2 = (((G__12548__$1 == null))?null:reagent$impl$component$component_path(G__12548__$1));
if((G__12548__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12548__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__12550 = c;
var G__12550__$1 = (((G__12550 == null))?null:G__12550.constructor);
if((G__12550__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12550__$1);
}
}
})();
